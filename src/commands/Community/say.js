...
module.exports = {
    ...
    .addStringOption(option => option.setName('message').setDescription('Message provided will be sent as PixelVal').setRequired(true).setMaxLength(2000).setMinLength(1))
